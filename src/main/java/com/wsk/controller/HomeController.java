...
public class HomeController {
    ...
    public String Recommend(HttpServletRequest request, Model model){//HttpServletRequest request, Model model
        ...
        List<GoodsWeight> recommendshop = demoService.shopWeight(uid);
        System.out.println("这里怎么样了");
        System.out.println("输出结果"+recommendshop);

        try {
            System.out.println("这里有什么");
            System.out.println(recommendshop);

            List<ShopInformation> shopInformations = demoService.chaxun(recommendshop);

            System.out.println("zheli"+recommendshop);
            System.out.println(shopInformations);
            List<ShopInformationBean> list = new ArrayList<>();
            int counts = getShopCounts();
            model.addAttribute("shopInformationCounts", counts);
            String sortName;
